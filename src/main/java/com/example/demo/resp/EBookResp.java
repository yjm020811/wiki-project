...
public class EBookResp {
    ...
    public EBookResp(Integer id, String name, Integer category1_id, Integer category2_id, String description, String cover, Integer doc_count, Integer view_count, Integer vote_count) {
        this.id = id;
        this.name = name;
